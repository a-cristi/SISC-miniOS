...
//
// As taken from Windows Kits\8.1\Include\shared\ntstatus.h (most comments removed)
//
...
//
// Define our own facility
//
#define SOARE_FACILITY  0x156

//
// To be used when declaring new statuses
//
#define MAKE_STATUS(sev, fac, c)    (NTSTATUS)(((sev) << 30) | (1 << 29) | ((fac) << 16) | (c))

//
// Severity levels
//
#define STATUS_SEVERITY_ERROR                        ((NTSTATUS)0x00000003L)
#define STATUS_SEVERITY_INFORMATIONAL                ((NTSTATUS)0x00000001L)
#define STATUS_SEVERITY_SUCCESS                      ((NTSTATUS)0x00000000L)
#define STATUS_SEVERITY_WARNING                      ((NTSTATUS)0x00000002L)
...
#define STATUS_ALREADY_INITIALIZED                  MAKE_STATUS(STATUS_SEVERITY_ERROR, SOARE_FACILITY, 0x0003)
#define STATUS_SIGNATURE_NOT_MATCHED                MAKE_STATUS(STATUS_SEVERITY_ERROR, SOARE_FACILITY, 0x0004)
#define STATUS_INVALID_CHECKSUM                     MAKE_STATUS(STATUS_SEVERITY_ERROR, SOARE_FACILITY, 0x0005)
